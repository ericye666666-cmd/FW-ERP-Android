...
grep -q 'printStoreItemLabels' "$ROOT_DIR/app/src/main/java/com/directloop/pda/DirectLoopPdaPrinterBridge.kt"
grep -q 'printOfficialStoreItemLabels' "$ROOT_DIR/app/src/main/java/com/directloop/pda/DirectLoopPdaPrinterBridge.kt"
grep -q 'StoreItemLabelPrintPayload' "$ROOT_DIR/app/src/main/java/com/directloop/pda/ChitengS1OfficialPrinterClient.kt"
grep -q 'drawStoreItemLabel' "$ROOT_DIR/app/src/main/java/com/directloop/pda/ChitengS1OfficialPrinterClient.kt"
grep -q 'BarCode.CODE_128' "$ROOT_DIR/app/src/main/java/com/directloop/pda/ChitengS1OfficialPrinterClient.kt"
grep -q 'machine_code' "$ROOT_DIR/app/src/main/java/com/directloop/pda/ChitengS1OfficialPrinterClient.kt"
grep -q 'price_kes' "$ROOT_DIR/app/src/main/java/com/directloop/pda/ChitengS1OfficialPrinterClient.kt"
grep -q 'category_short' "$ROOT_DIR/app/src/main/java/com/directloop/pda/ChitengS1OfficialPrinterClient.kt"
grep -q 'STORE_ITEM_LABEL' "$ROOT_DIR/app/src/main/java/com/directloop/pda/DirectLoopPdaPrinterBridge.kt"
